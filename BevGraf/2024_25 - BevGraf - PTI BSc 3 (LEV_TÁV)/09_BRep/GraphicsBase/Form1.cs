...
namespace GraphicsBase
{
    public partial class Form1 : Form
    {
        ...
        private void canvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            ExtensionGraphics.Transformation.LoadIdentity();
            ExtensionGraphics.Transformation.Push(Matrix4F.Transformation.Scale(lambda1));
            ...
            ExtensionGraphics.Transformation.Push(Matrix4F.Transformation.Translate(-300, 50, -200));
            g.DisplayBRepBackfaceCulling(pen1, cube1);

            ExtensionGraphics.Transformation.LoadIdentity();
            ExtensionGraphics.Transformation.Push(Matrix4F.Transformation.Scale(lambda2));
            ...
            ExtensionGraphics.Transformation.Push(Matrix4F.Transformation.Translate(400, -50, 0));
            g.DisplayBRepBackfaceCulling(pen2, cube2);
        }
